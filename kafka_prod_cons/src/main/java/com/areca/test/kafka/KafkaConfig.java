...
@Configuration
@EnableKafka // Required to listen kafka events
public class KafkaConfig {
    ...
    public ProducerFactory<String, SimpleModel> producerFactory(){
        ...
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9092"); // Kafka default port
    ...
    public ConsumerFactory<String, SimpleModel> consumerFactory(){
        ...
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9092"); // Kafka default port
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "myGroupId"); // Consumer groupid is required
